...
save_q2 = deg2rad(-20:0.5:20);
save_q3 = deg2rad(0:0.5:90);
save_q4 = deg2rad(0:0.5:90);
...
%             pos = double(subs(p26,old,new));
            ...
            q3 = save_q3(j);
            q4 = save_q4(k);
            save_cond(i,j,k) = cond(mf_J(q2,q3,q4));
            val = svd(mf_J(q2,q3,q4));
...
save('data.mat','save_q2','save_q3','save_q4','save_x','save_y','save_z','save_cond','save_sig1','save_sig2','save_sig3')
...
figure(2);
subplot(2,3,1)
a = sqrt(1/save_sig1(P6_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P6_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P6_index));  % z轴方向的半长轴 
...
subplot(2,3,2)
a = sqrt(1/save_sig1(P5_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P5_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P5_index));  % z轴方向的半长轴 
ellipsoid(center(1), center(2), center(3), a, b, c/rate);
title('cond=0.2');
grid on;
axis equal
...
subplot(2,3,3)
a = sqrt(1/save_sig1(P4_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P4_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P4_index));  % z轴方向的半长轴 
ellipsoid(center(1), center(2), center(3), a, b, c/rate);
title('cond=0.3');
grid on;
axis equal
...
subplot(2,3,4)
a = sqrt(1/save_sig1(P3_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P3_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P3_index));  % z轴方向的半长轴 
ellipsoid(center(1), center(2), center(3), a, b, c/rate);
title('cond=0.5');
grid on;
axis equal
...
subplot(2,3,5)
a = sqrt(1/save_sig1(P2_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P2_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P2_index));  % z轴方向的半长轴 
ellipsoid(center(1), center(2), center(3), a, b, c/rate);
title('cond=0.7');
grid on;
axis equal
...
subplot(2,3,6)
a = sqrt(1/save_sig1(P1_index));  % x轴方向的半长轴
b = sqrt(1/save_sig2(P1_index));  % y轴方向的半长轴
c = sqrt(1/save_sig3(P1_index));  % z轴方向的半长轴 
ellipsoid(center(1), center(2), center(3), a, b, c/rate);
title('cond=0.9');
grid on;
axis equal
